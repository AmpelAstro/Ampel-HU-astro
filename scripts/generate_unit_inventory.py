...
parser.add_argument("--target-file", help="append list to a file. if omitted, print to stdout")
...
cb = DistConfigBuilder(
    options=DisplayOptions(
        verbose=False, hide_stderr=True, hide_module_not_found_errors=True
    ),
)
...
if args.target_file:
    fileobj = open(args.target_file, "r+")
