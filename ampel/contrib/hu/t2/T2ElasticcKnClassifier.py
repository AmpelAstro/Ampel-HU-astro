...
#        kn_class['classifierName'] += 'AtRest'
        ...
        falls = [ features.get('fall_slope_'+band) for band in self.rest_bands 
                      if 'fall_slope_'+band in features.keys()] 
        rise = [ features.get('rise_slope_'+band) for band in self.rest_bands  
                      if 'rise_slope_'+band in features.keys()] 
