#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# File:                Ampel-HU-astro/ampel/t3/LightcurveMapReader.py
# License:             BSD-3-Clause
# Author:              ernstand
# Date:                01.11.2023
# Last Modified Date:  01.11.2023
# Last Modified By:    ernstand <ernstand@physik.hu-berlin.de>
...
class LightcurveMapReader(AbsT3PlainUnit):
    """
    Based on map, lightcurve stored in directory:
    - load lightcurve as alert
    - find pixels given requested prob contour.
    - propagate alert to consumer 
    """
